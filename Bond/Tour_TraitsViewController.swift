//
//  Bond_TraitsViewController.swift
//  Bond
//
...
class Tour_TraitsViewController: UIViewController {
    ...
    func setup(frame: CGRect) {
        ...
        icon.setDefaultImage(UIImage(named: "Tour_3.png")!)
        ...
        descLabel.text = "Everyone is unique and using a series \n of extensively researched traits we are \n able to determine likeminded people."

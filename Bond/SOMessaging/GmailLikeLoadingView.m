...
/*
		colorsArray = [NSMutableArray arrayWithObjects:
					   [UIColor colorWithRed:0.0/255.0f green:147.0/255.0f blue:78.0/255.0f alpha:1.0],
					   [UIColor colorWithRed:20.0/255.0f green:99.0/255.0f blue:233.0/255.0 alpha:1.0],
					   [UIColor colorWithRed:255.0/255.0f green:199.0/255.0f blue:12.0/255.0f alpha:1.0],
 ...
 */
		...
		colorsArray = [NSMutableArray arrayWithObjects:
					   ...
					   UIColorFromRGB(0x1dafff),
					   UIColorFromRGB(0x00a4ff),
					   nil];
